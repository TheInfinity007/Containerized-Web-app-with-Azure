...
app.get("/", (req, res) => {
  res.send(
    "<html><body><h1>Hello World! <br>Redeploying after code change<br> Setting up continuous deployement setting to 'ON' in deployment center Web App setting</h1></body></html>"
  );
});
